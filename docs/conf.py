# -*- coding: utf-8 -*-
#
# Tesina_modelli documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    ('index',
     'tesina.tex',
     u'Tesina_modelli Documentation',
     u"Vincenzo Y. Civale", 'manual'),
]
...
man_pages = [
    ('index', 'tesina', u'Tesina_modelli Documentation',
     [u"Vincenzo Y. Civale"], 1)
]
...
texinfo_documents = [
    ('index', 'tesina', u'Tesina_modelli Documentation',
     u"Vincenzo Y. Civale", 'Tesina_modelli',
